document.addEventListener('DOMContentLoaded', function () {
    ...
    function extractData() {
        try {
            const data = {
                room_name: document.querySelector('.room-name').innerText, // Add room name
                ...
                tenantId: localStorage.getItem('uniqueRoomId'), // Add Tenant ID
    ...
    document.querySelector('.csvbtn').addEventListener('click', function () {
        ...
        const csvData = [
            ['Label', 'Value'],
            ['Room Name', data.room_name], // Add Room Name to CSV data
            ['Date', data.date],
            ...
            ['Price', data.price],
            ['Tenant ID', data.tenantId], // Add Tenant ID to CSV data
            ['Landlord ID', data.landlordId] // Add Landlord ID to CSV data
        ];
